...
<div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
    <a href="{{ url('/bookcheckouts/create') }}" class="btn btn-primary me-md-2" type="button">
        Add New Bookcheckout
    </a>
</div>
                ...
                @foreach($checkouts as $checkout)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('/bookcheckouts/' . $checkout->id . '/edit') }}" class="btn btn-primary">
